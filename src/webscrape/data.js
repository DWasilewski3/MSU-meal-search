...
export let favoriteMeals = ['Butter Chicken', 'Tempura Chicken', 'Ham', 'Philly Beef Sandwich', 'Chicken Taco', 'Mississippi Mud Brownie', 'Pulled Pork Quesadilla'];  // replace with your actual favorite meals
...
export let searchMeal = 'Butter Chicken';

export const baseUrls = ['https://eatatstate.msu.edu/menu/The%20Edge%20at%20Akers/all/', 'https://eatatstate.msu.edu/menu/Brody%20Square/all/',
